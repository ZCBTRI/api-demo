...
public class AddUserToWhiteList {
    private static final Logger logger = LoggerFactory.getLogger(AddUserToWhiteList.class);

    // 授时存证代理合约的合约地址
    private static final String contractAddress = ApplicationConfig.registryNTSCProxy;
    // 授时存证合约的合约地址
    private static final String registryNTSCAddress = ApplicationConfig.registryNTSCAddress;
    // 要添加的身份合约的账户ID
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        final Object[] params = {registryNTSCAddress, accountID};
        // 获取待签原文
