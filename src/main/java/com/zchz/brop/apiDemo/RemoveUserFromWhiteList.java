...
public class RemoveUserFromWhiteList {
    private static final Logger logger = LoggerFactory.getLogger(RemoveUserFromWhiteList.class);
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        final String method = "removeUserFromWhiteList";
